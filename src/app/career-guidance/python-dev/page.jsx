...
const initialNodes = [
  { id: '1', position: { x: 690, y: 0 }, data: { label: 'Python Full Stack Development' } },
  ...
  // Backend Branch (Python)
  { id: '6', position: { x: 690, y: 300 }, data: { label: 'Backend' }, style: { backgroundColor: '#ffcccb' } },
  { id: '7', position: { x: 690, y: 400 }, data: { label: 'Python' }, style: { backgroundColor: '#add8e6' } },
  { id: '8', position: { x: 690, y: 500 }, data: { label: 'Frameworks' }, style: { backgroundColor: '#f9f9f9' } },
  { id: '9', position: { x: 600, y: 600 }, data: { label: 'Django' }, style: { backgroundColor: '#add8e6' } },
  { id: '10', position: { x: 800, y: 600 }, data: { label: 'Flask' }, style: { backgroundColor: '#add8e6' } },
...
const initialEdges = [
  // Connecting Python Full Stack Development to Frontend, Backend, and Databases
  ...
  // Backend connections (Python and Frameworks)
