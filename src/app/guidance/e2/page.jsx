import {
  ...
  import { coresubjects, cp } from "@/data/batchwise-data/e2";
  ...
  export default function Page() {
    return (
      <div className="space-y-6">
        ...
        <div className="space-y-4 bg-card p-3 rounded-lg shadow-md dark:bg-slate-700">
          
  
          <div>
            <h3 className="text-xl font-semibold texbl ">Blogs</h3>
